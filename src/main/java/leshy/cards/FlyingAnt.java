...
public class FlyingAnt extends AbstractCreatureCard {


    public static final String ID = LeshyMod.makeID(FlyingAnt.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("FlyingAnt.png");
    ...
    public FlyingAnt() {
        ...
        sigilImgPath = makeCardPath("FlyingAnt_Sigil.png");
