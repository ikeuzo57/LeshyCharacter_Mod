    ...
    public static class ButtonEffect {
        ...
        public static void Insert(NeowEvent __instance, int buttonPressed) {
            ...
            if(AbstractDungeon.player instanceof Leshy){
                dismissBubble();
                AbstractDungeon.effectList.add(new InfiniteSpeechBubble(1100.0F * Settings.xScale, AbstractDungeon.floorY + 60.0F * Settings.yScale, "~Denizens~ ~of~ ~the~ ~forest~ ~approach.~"));
                __instance.roomEventText.updateDialogOption(0, "#gAdd #g4 #gCreatures #gto #gyour #gdeck.");
            }
        ...
        public static SpireReturn Prefix(NeowEvent __instance, int buttonPressed) {
            ...
            if (AbstractDungeon.player instanceof Leshy && (int) ReflectionHacks.getPrivate(__instance, NeowEvent.class, "screenNum") == 99) {
                ...
                AbstractDungeon.gridSelectScreen.open(sealedGroup, 4, "Add 4 Creatures to your deck.", false);
